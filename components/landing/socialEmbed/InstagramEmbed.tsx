...
const InstagramProfileEmbed: React.FC<InstagramProfileEmbedProps> = ({ profileUrl }) => {
  ...
  useEffect(() => {
    if (containerRef.current && !initialized.current) {
      ...
      blockquote.setAttribute('data-instgrm-permalink', profileUrl);
